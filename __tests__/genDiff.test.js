...
const receivedForJsonTest = getStylish(genDiff(pathOfInitialFileJson, pathOfChangedFileJson));
...
const receivedForYmlTest = getStylish(genDiff(pathOfInitialFileYml, pathOfChangedFileYml));
